...
import {
  xy,
  clipPath_bottom_top_Trigger,
  clipPath_bottom_top,
  changeBG,
} from "../../motions/animation";
const Index = () => {
  useGSAP(() => {
      ...
      <div className="learning">
        <div className="description">
          ...
          <div className="paragraphe">
            Discover our sophisticated matchmaking algorithm, designed to
            connect you with your soulmate by taking into account your unique
            interests, values and preferences, where each match has the
            potential to become an exceptional love story
          </div>
        </div>
